...
public class MayhemDriverPad {
        ...
        public final Trigger DRIVER_PAD_BUTTON_FIVE = new JoystickButton(DRIVER_PAD, 5); // Left Top Trigger;
        public final Trigger DRIVER_PAD_BUTTON_SIX = new JoystickButton(DRIVER_PAD, 6); // Right Top Trigger;
        public final Trigger DRIVER_PAD_LEFT_STICK_BUTTON = new JoystickButton(DRIVER_PAD,
                        GAMEPAD_BUTTON.GAMEPAD_F310_LEFT_STICK_BUTTON); // Left;
        public final Trigger DRIVER_PAD_RIGHT_STICK_BUTTON = new JoystickButton(DRIVER_PAD,
        ...
        public final Trigger CLIMB_L3_BUTTON_PAIR = new AndJoystickButton(DRIVER_PAD,
                        GAMEPAD_BUTTON.GAMEPAD_F310_Y_BUTTON, DRIVER_PAD, GAMEPAD_BUTTON.GAMEPAD_F310_LEFT_BUTTON); // Y=Yellow,
                                                                                                                    // plus
                                                                                                                    // left
                                                                                                                    // top
                                                                                                                    // trigger
        public final Trigger CLIMB_L2_BUTTON_PAIR = new AndJoystickButton(DRIVER_PAD,
        ...
        public final Trigger DRIVER_PAD_BACK_BUTTON = new JoystickButton(DRIVER_PAD,
                        GAMEPAD_BUTTON.GAMEPAD_F310_BACK_BUTTON);
        public final Trigger DRIVER_PAD_START_BUTTON = new JoystickButton(DRIVER_PAD,
                        GAMEPAD_BUTTON.GAMEPAD_F310_START_BUTTON);

        public final Trigger DRIVER_PAD_GREEN_BUTTON = new JoystickButton(DRIVER_PAD, 1);;
        public final Trigger DRIVER_PAD_RED_BUTTON = new JoystickButton(DRIVER_PAD, 2); // RED 'B" button
        public final Trigger DRIVER_PAD_BLUE_BUTTON = new JoystickButton(DRIVER_PAD, 3); // BLUE 'X' button
        public final Trigger DRIVER_PAD_YELLOW_BUTTON = new JoystickButton(DRIVER_PAD, 4); // YELLOW 'Y' button

        public MayhemDriverPad() {
        }

        private static final double THROTTLE_DEAD_ZONE_PERCENT = 0.20;
        private static final double MIN_THROTTLE_FOR_MOVEMENT = 0.00; // what is the min throttle for Movement
        private static final double NORMAL_MAX_THROTTLE = 0.80; // maximum speed is normally 100%
        // private static final double SLOW_MODE_MAX_THROTTLE = 0.30; // maximum
        // throttle in "slow mode" is 30%
        ...
        // private static final double SLOW_MODE_MAX_STEERING = 0.80; // maximum
        // steering in "slow mode" is 50%
